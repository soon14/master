	...
	<div class="page-content">
		<div class="row-fluid">
			<div class="col-xs-12">
				...
				<input type='hidden' class='pageSize'  name='pageSize' value='30'/>
				</form>
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:9%" class="center hidden-480">任务类型</th>
							<th style="width:11%" class="center ">任务名称</th>
							<th style="width:5%" class="center  " >使用状态</th>
							<th style="width:12%" class="center hidden-480" >描述</th>
							<th style="width:12%" class="center hidden-480" >创建人</th>
							<th style="width:9%" class="center  hidden-480" ><i class="icon-time bigger-110 hidden-480"></i>创建时间</th>
							<th style="width:12%" class="center hidden-480" >修改人</th>
...
<script src="${jypath}/static/js/system/task/cpScheduleJobConfig.js"></script>
</body>
</html>