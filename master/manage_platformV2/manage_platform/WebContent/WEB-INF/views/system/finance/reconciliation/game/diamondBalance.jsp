            ...
            <form id="fundsForm" class="form-inline" method="POST" onsubmit="return false;">
                <div class="row">
                    <div class="widget-main">
                        ...
                        <a id='excelsReport' class="btn btn-warning  btn-xs" href="#" onclick="javascript:exportReport('${jypath}/backstage/reconciliation/diamondBalance/download')">导出报表</a>
                    </div>
                </div>
       <%--         <div class="row">
            ...
            <table id="fundsTable" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th style="width:5%" class="center" >期初钻石数</th>
                    <th style="width:5%" class="center hidden-480" >期初结余金额</th>
                    <th style="width:7%" class="center hidden-480" >本期充值钻石数</th>
                    <th style="width:5%" class="center hidden-480" >本期充值金额</th>
                    <th style="width:5%" class="center hidden-480" >钻石货币单价（加权平均）</th>
                    <th style="width:7%" class="center hidden-480" >本期充值钻石消耗数</th>
                    <th style="width:5%" class="center hidden-480" >本期充值钻石结转价值</th>
                    <th style="width:5%" class="center hidden-480" >本期结余充值钻石数量</th>
                    <th style="width:5%" class="center hidden-480" >期末结余充值金额</th>
                    <th style="width:5%" class="center hidden-480" >期末钻石货币单价（加权平均）</th>
                </tr>
                </thead>
                <tbody></tbody>
            </table>
            <div>
                ...
                <span style="color: red">钻石货币单价（加权平均）：(本期充值金额+期初结余金额)/(本期充值钻石数+期初钻石数)</span><br>
                <span style="color: red">期末钻石货币单价（加权平均）：期末结余充值金额/本期结余充值钻石数量</span>
            </div>
            <div class="row">
                <div class="col-sm-4">
...
<script src="${jypath}/static/js/system/finance/reconciliation/game/diamondBalance.js"></script>
</body>
</html>