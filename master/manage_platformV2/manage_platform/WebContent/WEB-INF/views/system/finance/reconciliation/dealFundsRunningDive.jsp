		...
		<table cellspacing="0" cellpadding="0" border="0" class="customTable">
			...
			<tr class="FormData">
				...
				<td class="DataTD">&nbsp;
					...
					<select  id ="dDifferenceType" name="dDifferenceType"  >
						<option  value = "1" >彩票系统有，第三方无</option >
						<option  value = "2" >彩票系统无，第三方有</option >
						<option  value = "3" selected = "selected">金额差异</option >
						<option  value = "4" >时间差异</option >
					</select >
				</td>
			</tr>
			<tr class="FormData">
...
<script src="${jypath}/static/js/system/finance/reconciliation/dealFundsRunningDive.js"></script>
</body>
</html>