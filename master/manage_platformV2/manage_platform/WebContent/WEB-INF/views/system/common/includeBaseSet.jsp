...
<!--提示组件end-->
<link rel="icon" href="${jypath}/daysluck.ico" type="image/x-icon" />
<link rel="shortcut icon" href="${jypath}/daysluck.ico" type="image/x-icon" />
<link rel="bookmark" href="${jypath}/daysluck.ico" type="image/x-icon" />
