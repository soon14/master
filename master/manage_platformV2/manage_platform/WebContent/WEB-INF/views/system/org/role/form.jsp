			...
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData form-inline">
						...
						<td class="DataTD ">&nbsp;
							<span id="selectOrgLevel"><select name="orgLevel" jyValidate="required" class="form-control isSelect105"></select>级数越高,职务越小</span>
						</td>
					</tr>
		...
		<form id="auForm" method="POST" onsubmit="return false;" >
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData form-inline">
						<td class="CaptionTD"><font color="red">*</font>角色级别：</td>
						<td class="DataTD ">&nbsp;
							<span id="selectPosLevel"><select name="posLevel" jyValidate="required" class="form-control isSelect105"></select>级数越高,职务越小</span>
						</td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>上级组织：</td>
						<td class="DataTD">&nbsp;
							<input id="pre" type="text" readonly value="" jyValidate="required" class="FormElement ui-widget-content ui-corner-all" onclick="showPreOrg(); return false;"/>
							<input type="hidden" name="orgId" value="0" >
							<div id='preContent' class="menuContent ztreeMC" style="display: none; position: absolute;">
