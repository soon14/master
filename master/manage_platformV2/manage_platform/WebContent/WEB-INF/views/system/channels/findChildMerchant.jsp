		...
		<div class="col-xs-12">
			...
			<table id="baseTable" class="table table-striped table-bordered table-hover" >
				...
				<tr>
					...
					<th style="width:20%" class="center hidden-480">渠道类型</th>
					<th style="width:20%" class="center hidden-480">手机号</th>
					<th style="width:20%" class="center hidden-480">发展客户数</th>
					<th style="width:20%" class="center hidden-480">渠道来源</th>
				</tr>
				</thead>
				<tbody></tbody>
			</table>
...
<script src="${jypath}/static/js/system/channels/findChildMerchant.js"></script>
</body>
</html>