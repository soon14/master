		...
		<div class="col-xs-12">
			<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
				<div class="row">
					...
					<%--</div>--%>
					<div class="widget-main">
						<input name="userName" value=""  type="text" placeholder="客户名称" >
						<input name="phone" value=""  type="text" placeholder="手机号码" >
			...
			<table id="baseTable" class="table table-striped table-bordered table-hover" >
				<thead>
				<tr>
					<th style="width:10%"  class="center hidden-480">客户编号</th>
					<th style="width:10%" class="center" id="name">客户名称</th>
					...
					<th style="width:15%" class="center hidden-480">标记时间</th>
			...
			<div >
				<%--<table>--%>
					...
					<%--<tr  style='font-weight:bold;color:#F00'>--%>
						<%--<td >--%>
							<%--1.销量统计默认为一个月的数据.包含个人购彩金额和归属客户购彩金额.--%>
						<%--</td>--%>
					<%--</tr>--%>
					<%--<tr  style='font-weight:bold;color:#F00'>--%>
						<%--<td >--%>
...
<script src="${jypath}/static/js/system/channels/countCustomer.js"></script>
<script>
