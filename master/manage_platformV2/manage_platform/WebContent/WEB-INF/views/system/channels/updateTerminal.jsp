	...
	<form id="form1" method="post" class="form">
		...
		<tbody>
			<tr class="FormData">
				...
				<td>
					<input type="text" maxlength="32"  name="machineNum" id="machineNum" value ="${machineNum}"placeholder="请输入机器码">
				</td>
			</tr>
			<tr class="FormData">
				...
				<td>
					...
					<select id="merchantName" name="merchantName" value ="${merchantName}" placeholder="请选择">
					</select>
				</td>
			</tr>
...
<script src="${jypath}/static/js/system/channels/updateTerminal.js"></script>
<script type="text/javascript">
	$(function () {
		findMerchantForUpdate();
		});
</script>
</body>
</html>