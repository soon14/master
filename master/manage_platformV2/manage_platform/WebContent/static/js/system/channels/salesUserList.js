$(function () {
	...
	function getbaseList(init) {
		...
		JY.Model.loading();
		JY.Ajax.doRequest("baseForm", jypath + '/backstage/salesVolume/salesUserList', null, function (data) {
			...
			if (results != null && results.length > 0) {
				...
				for (var i = 0; i < results.length; i++) {
					...
					html += "<td class='center hidden-480' >"+ JY.Object.notEmpty(l.type==0?"个人":"企业") +"</td>";
