...
function getbaseList(init) {
	...
	JY.Model.loading();
    JY.Ajax.doRequest("baseForm",jypath +'/channels/findChildCustomerByMId',null,function(data){
		...
		if (results != null && results.length > 0) {
			...
			for (var i = 0; i < results.length; i++) {
                ...
                html += "<td class='center hidden-480' >" + JY.Date.Format(l.buyTime,'yyyy-MM-dd hh:mm:ss')+ "</td>";
				html += "</tr>";
			}
