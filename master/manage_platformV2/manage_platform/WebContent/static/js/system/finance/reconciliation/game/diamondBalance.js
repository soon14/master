...
function getList(init) {
    ...
    JY.Model.loading();
    JY.Ajax.doRequest("fundsForm", jypath + '/backstage/reconciliation/diamondBalance/findByPage', null, function (data) {
        ...
        if (results != null && results.length > 0) {
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                html += "<td class='center hidden-480'  '>" + JY.Object.notEmpty(res.qcDiamond) + "</td>";
                html += "<td class='center hidden-480'>" + JY.Object.notEmpty(res.qcMoney) + "</td>";
                html += "<td class='center hidden-480'>" + JY.Object.notEmpty(res.addDiamond) + "</td>";
                html += "<td class='center hidden-480'>" + JY.Object.notEmpty(res.addMoney) + "</td>";
                html += "<td class='center hidden-480'>" + JY.Object.notEmpty(res.averageDiamond) + "</td>";
                html += "<td class='center hidden-480'>" + JY.Object.notEmpty(res.consumeDiamond) + "</td>";
                html += "<td class='center hidden-480'>" + JY.Object.notEmpty(res.addDiamondToMoney) + "</td>";
                html += "<td class='center hidden-480'>" + JY.Object.notEmpty(res.qmDiamond) + "</td>";
                html += "<td class='center hidden-480'>" + JY.Object.notEmpty(res.qmMoney) + "</td>";
                html += "<td class='center'>" + JY.Object.notEmpty(res.qmAverageDiamond) + "</td>";
                html += "</tr>";
            }
