...
function getDataList(){
    JY.Model.loading();
    JY.Ajax.doRequest("baseForm", jypath + '/statistics/lotteryWaySale/findDiffList', null, function (data) {
        ...
        if (results != null && results.length > 0) {
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                // html += "<td class='center hidden-480' >" + JY.Object.notEmpty(l.extendMoney) + "</td>";
                // html += "<td class='center hidden-480' >" + JY.Object.notEmpty(l.ticket) + "</td>";
