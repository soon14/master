$(function () {
	...
	function getbaseList(init) {
		...
		JY.Model.loading();
		JY.Ajax.doRequest("baseForm", jypath + '/statistics/qrCodeDailyReport/findByPage', null, function (data) {
			...
			if (results != null && results.length > 0) {
				...
				for (var i = 0; i < results.length; i++) {
					...
					html += "<td class='center hidden-480' >" + JY.Object.notEmpty(l.startNum) + "</td>";
					html += "<td class='center hidden-480'>" + JY.Object.notEmpty(l.saleMoney) + "</td>";
					html += "<td class='center hidden-480'>" + JY.Object.notEmpty(l.diffNum) + "</td>";
					html += "<td class='center hidden-480'>" + JY.Object.notEmpty(l.endNum) + "</td>";
...
$('#resetData').bind('click', function() {
	...
	JY.Model.loading();
	JY.Ajax.doRequest("baseForm",jypath +'/statistics/qrCodeDailyReport/manual',null,function(data){
		JY.Model.loadingClose();
		var obj=data.obj;
