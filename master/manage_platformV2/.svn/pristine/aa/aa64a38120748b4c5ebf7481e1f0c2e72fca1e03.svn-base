        ...
        <div class="col-xs-12">
            ...
            <table id="baseTable" class="table table-striped table-bordered table-hover" >
                ...
                <tr>
                    ...
                    <th style="width:10%" class="center hidden-480">联系方式</th>
                    <th style="width:8%"  class="center ">注册时间</th>
                </tr>
                </thead>
                <tbody></tbody>
            </table>
...
<script src="${jypath}/static/js/system/channels/salesUserList.js"></script>
</body>
</html>