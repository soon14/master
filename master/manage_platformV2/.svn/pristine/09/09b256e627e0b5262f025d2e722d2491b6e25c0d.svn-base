...
public interface RoleDao extends BaseDao<Role>{
	 ...
	 * 角色组织树
	 */
	public List<ZNodes> getOrgTreesByRole(@Param("roleId") String roleId);
	 /**
     * 根据角色Id删除所有权限关系
     * @param roleId 角色Id
     * @return
	 ...
	 * @param id
	 */
	public void deleteRole_Org(@Param("roleId") String id);
	/**
	 *
	 * @方法功能描述： 新增角色租
	 * @param
	 */
	public void savePos_Org(@Param("list") List list);
