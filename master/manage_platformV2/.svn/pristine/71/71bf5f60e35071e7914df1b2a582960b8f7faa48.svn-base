        ...
        <div class="col-xs-12">
            <form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
                <div class="row">
                    ...
                    &nbsp;&nbsp;<button id='searchBtn' class="btn btn-warning  btn-xs" title="查询" type="button" onclick="getbaseList(1)"><i class="icon-search bigger-110 icon-only"></i></button>
                        ...
                        <a id='excelReport' class="btn btn-warning  btn-xs" href="#" onclick="javascript:exportReport('${jypath}/statistics/lotteryWaySale/downloadOrderTicket')">导出报表</a>
                        <%--<a id='downReport' class="btn btn-warning  btn-xs" href="#" onclick="javascript:exportReport('${jypath}/statistics/lotteryWaySale/downloadOrderTicketDiff')">导出差异报表</a>--%>
                    </div>
                </div>
            ...
            <table id="baseTable" class="table table-striped table-bordered table-hover" >
                ...
                <tr>
							...
							<th style="width: 7%" class="center hidden-480" colspan="4">方案(出票)金额</th>
							<th style="width: 7%" class="center hidden-480" rowspan="2">出票金额</th>
							<th style="width: 7%" class="center hidden-480" rowspan="2">差异</th>
                </tr>
                <tr>
                    <th style="width: 10%" class="center hidden-480">购彩（出票）</th>
                    <th style="width: 7%" class="center hidden-480" >追期（出票）</th>
                    <th style="width: 7%" class="center hidden-480">商户活动（出票）</th>
...
<script src="${jypath}/static/js/system/finance/statistics/lottery/orderTicketReport.js"></script>
