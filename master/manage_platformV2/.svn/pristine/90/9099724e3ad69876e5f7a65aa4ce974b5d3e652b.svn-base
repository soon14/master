...
public interface LotteryWaySaleReportDao extends BaseDao<LotteryWaySaleReport>{
	...
	List<OrderTicketDiffReport> findOrderTicketReportDiffByDate(String date);
	...
	//追期类型，方案单边账
	List<OrderTicketDiffReport>  findTranceDiffOrder(String beginTime,String endTime,String date2);
	//追期类型，票单边账
	List<OrderTicketDiffReport>  findTranceDiffTicket(String beginTime,String endTime,String date2);
	//普通购彩类型，方案单边账
