...
public interface PlatformFundsDao extends BaseDao<PlatformFunds> {
    ...
    public List<PlatformFunds> findFundsListByDate(@Param("startDate") String date, @Param("status") Integer status, @Param("type") Integer type);
    ...
    public List<PlatformFundsRunning> findFundsRunningListByDate(@Param("startDate") String date, @Param("status") Integer status);
     ...
     * @return
     */
    public Double findPrizeByDate(@Param("commonOrMerchantNo")Integer commonOrMerchantNo,String beginTime, String endTime);
...
//-----------------------------------第三方流水-------------------------------------------------
    ...
    List<FundsDiveVo> findDiveVoListBetweenCpAndThird(String beginTime, String endTime);

    Double findTotalDealMoney(String beginTime, String endTime);
    ...
    Double findTotalBuyPick(String beginTime, String endTime, int commonOrMerchantNo,String day);
...
//    Double findActivityQcyeByDate(String beginTime, String endTime);
    ...
    Double findRefundDrawOrTicket(@Param("commonOrMerchantNo")Integer commonOrMerchantNo,int i, String beginTime, String endTime);

    Double findBuyTranceOrCommon(@Param("isCommon")int isCommon,@Param("isTrance")int isTrance, String beginTime, String endTime,String day);
    ...
    Double find356TotalBuy(String beginTime, String endTime,String day);

    Double getMoneyByTypeOrChannel(Integer type, String beginTime, String endTime);

    List<PlatformFunds> findCommonFundsDiff(String date, String endTime, String nextDay);

    Double findInternalDeposit(@Param("type")int commonOrMerchantNo, String beginTime, String endTime);

    Double findInternalExtraction(@Param("type")int commonOrMerchantNo, String beginTime, String endTime);
}
