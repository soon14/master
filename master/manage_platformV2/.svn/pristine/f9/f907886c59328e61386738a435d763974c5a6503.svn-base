...
<div class="page-content">
    <div class="row-fluid">
        <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="widget-main-marginleft18">
                        ...
                        <select   name="fundsType"  >
                            <option  value = "301" selected = "selected">正常</option >
                            <option  value = "301" >移动活动</option >
                            <option  value = "601" >得仕捕鱼</option >
                            <option  value = "501" >得仕棋牌</option >
                            <option  value = "401" >欧建活动</option >
                        </select >&nbsp;&nbsp;
                        ...
                        <%--<a id='excelReport' class="btn btn-warning  btn-xs" href="#" onclick="javascript:exportFundsReport('${jypath}/backstage/reconciliation/download')">汇总差异报表</a>--%>
                        <a id='excelCMCCReport' class="btn btn-warning  btn-xs" href="#" onclick="javascript:exportCMCCReport('${jypath}/backstage/reconciliation/download')">导出报表</a>
                    </div>
                </div>
            ...
            <table id="fundsTable" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th style="width:5%" class="center hidden-480" rowspan="3">充值金额</th>
                    <th style="width:7%" class="center hidden-480" colspan="4">购彩金额（委托）</th>
                    <th style="width:5%" class="center" rowspan="3">期末余额</th>
                    <th style="width:5%" class="center" rowspan="3">差异额</th>
                </tr>
                <tr>
                    <th style="width:7%" class="center hidden-480">中国移动</th>
                    <th style="width:7%" class="center hidden-480">得仕捕鱼</th>
                    <th style="width:7%" class="center hidden-480" >得仕棋牌</th>
                    <th style="width:7%" class="center hidden-480">欧建活动</th>
                </tr>
                </thead>
                <tbody></tbody>
            </table>
        ...
        <div>
            ...
            <span style="color: red">计算得出的期末余额：期初余额+充值金额-中国移动-得仕捕鱼-得仕棋牌-欧建活动</span><br>
...
<script src="${jypath}/static/js/system/finance/reconciliation/lottery/funds/activityFunds.js"></script>
</body>
</html>