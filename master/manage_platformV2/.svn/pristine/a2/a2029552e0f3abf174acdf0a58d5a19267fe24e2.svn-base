            ...
            <form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
                <div class="row">
                    ...
                    客户名称:<input type="text" name="userName"     placeholder="请输入客户名称">
                        <%--电话后四位:<input name="phone"  type="text" placeholder="请输入电话后四位" >--%>
                        <%--下单日期:<input name="beginTime" value="" class="date-picker" type="text" placeholder="开始日期" >--%>

                       <%-- <input name="endTime" value=""  class="date-picker" type="text" placeholder="结束日期" >--%>
<%--                        <span id="selectType">
                            <label></label>
                        <select  data-placeholder="类型" name="searchType" class="chosen-select isSelect95"></select></span>--%>
            ...
            <table id="baseTable" class="table table-striped table-bordered table-hover" >
                ...
                <tr>
                    ...
                    <th style="width:10%" class="center">方案编号</th>
                    <th style="width:10%" class="center hidden-480">购买金额</th>
                    <th style="width:8%"  class="center ">下单日期</th>
                </tr>
                </thead>
                <tbody></tbody>
...
<script src="${jypath}/static/js/system/channels/childMerchantAndSignList.js"></script>
</body>
</html>