        ...
        <div class="col-xs-12">
            <form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
                <div class="row">
                    ...
                    &nbsp;&nbsp;<button id='searchBtn' class="btn btn-warning  btn-xs" title="过滤" type="button" onclick="getbaseList(1)"><i class="icon-search bigger-110 icon-only"></i></button>
                        ...
                        <a id='excelReport' class="btn btn-warning  btn-xs" href="#" onclick="javascript:exportReport('${jypath}/statistics/qrCodeDetailDailyReport/exportReport')">导出报表</a>
                    </div>
                </div>
            ...
            <table id="baseTable" class="table table-striped table-bordered table-hover" >
                ...
                <tr>
                    ...
                    <th style="width:5%" class="center" colspan="7">兑换券未使用期初数</th>
                    <th style="width:5%" class="center" colspan="7">兑换券售出额</th>
                    <th style="width:5%" class="center" colspan="7">兑换券期未余额</th>

                </tr>
                <tr>
                    <th style="width:7%" class="center hidden-480">2元</th>
                    <th style="width:7%" class="center hidden-480">3元</th>

                    <th style="width:7%" class="center hidden-480">10元</th>
                    <th style="width:7%" class="center hidden-480">20元</th>
                    <th style="width:7%" class="center hidden-480">50元</th>
                    <th style="width:7%" class="center hidden-480">100元</th>
                    <th style="width:7%" class="center hidden-480">总金额</th>
                    <th style="width:7%" class="center hidden-480">2元</th>
                    <th style="width:7%" class="center hidden-480">3元</th>
...
<script src="${jypath}/static/js/system/finance/statistics/qrcode/qrDetailDailyReport.js"></script>
</body>
</html>