...
public class BettingDifferenceServiceImpl extends BaseServiceImp<BettingDifference> implements BettingDifferenceService {
     ...
     */
    @Override
    public Page<BettingDifference> differenceList(String date, Page<BettingDifference> page, String ids, int number) {
        List<BettingDifference> blist = this.fillDiffReason(this.bettingDifferenceDao.findByDate(date, ids,number));
    ...
    private List<BettingDifference> fillDiffReason(List<BettingDifference> blist) {
        for (BettingDifference bettingDifference : blist) {
            if (bettingDifference.getDfType().equals(SaleEnum.AMOUNT_DF.getValue())) {
                bettingDifference.setDfReason(String.format(SaleEnum.AMOUNT_DF.getViewName(), bettingDifference.getTicketNo(), bettingDifference.getDfDiffMoney()));
